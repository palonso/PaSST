...
class MTTDataset(TorchDataset):
    def __init__(self, groundtruth_file, base_dir="", sample_rate=16000, classes_num=50, clip_length=10, augment=False, hop_size=256, n_bands=96):
        """
...
def get_base_test_set(test_groundtruth, base_dir):
    return MTTDataset(test_groundtruth, base_dir)
...
if __name__ == "__main__":
    ...
    def default_command():
        ...
        ds = get_train_set()
        print(ds[0])
        print("get_training_set", len(get_traiget_train_dataloadersn_set()))
